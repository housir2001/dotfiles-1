...
main = do 
      ...
      -- hooks, layouts
        ...
        logHook = myLogHook <+> dynamicLogWithPP xmobarPP
                        ...
                        , ppCurrent = xmobarColor "" "" . wrap "[" "]" -- Current workspace in xmobar
                        , ppVisible = xmobarColor "" ""                -- Visible but not current workspace
                        , ppHidden = xmobarColor "" "" . wrap "*" ""   -- Hidden workspaces in xmobar
                        , ppSep =  "<fc=> <fn=2>|</fn> </fc>"          -- Separators in xmobar
                        , ppUrgent = xmobarColor "" "" . wrap "!" "!"  -- Urgent workspace
