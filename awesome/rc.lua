...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "Dev", "Web", "Com", "4", "5", "6" }, s, awful.layout.layouts[1])
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            wibox.widget.textbox('  |  '),
            awful.widget.watch('bash -c "/home/maren/dotfiles/scripts/sysInfo.sh -df"', 15),
            wibox.widget.textbox('  |  '),
            mytextclock,
            wibox.widget.textbox('  |  '),
            s.mylayoutbox,
...
globalkeys = gears.table.join(
  ...
  awful.key({ modkey }, "0",
    function ()
      awful.util.spawn("bash /home/maren/dotfiles/scripts/shutDown.sh")
  end,
  ...
  awful.key({ modkey }, "p",
    function ()
      awful.util.spawn("bash /home/maren/dotfiles/scripts/launcher.sh")
  end, {description = "custom launcher", group = "launcher"}),


  awful.key({ modkey }, "i",
    function ()
      awful.util.spawn("bash /home/maren/dotfiles/scripts/dmenuUnicode.sh")
